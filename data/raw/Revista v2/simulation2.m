...
%an approximately tracking type simulation using the complete interaction
%model, that is, the model with muscles and coordinate actuator.
...
OSimModelfileName = 'LowerLimbIM.osim';
...
%Altering the exoskeleton assistance level
alpha = 1;
beta = 10;
gain = alpha/beta;
effort.setWeightForControl('/forceset/act_hip_flexion_r', gain);
effort.setWeightForControl('/forceset/act_knee_angle_r', gain);
effort.setWeightForControl('/forceset/act_ankle_angle_r', gain);
